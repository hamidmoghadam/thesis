...
DATE=$(date '+%Y%m%d%H%M')
ROOT_DIR="/Users/hamidmoghaddam/Documents/thesis/social-media-forensics-master/microblog_authorship_attribution"
...
REPETITIONS="10"
FEATURES="char-4-gram"


echo "Running ... "
RUN_ID="pmsvm_classifier_char-grams_analysis_${VALIDATION_FOLDING}_${REPETITIONS}_${FEATURES}_${DATE}"
/Users/hamidmoghaddam/Documents/thesis/social-media-forensics-master/microblog_authorship_attribution/char-grams_analysis/pmsvm_classifier_char-grams.py \
